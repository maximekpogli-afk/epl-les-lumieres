  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'warm-gradient': 'linear-gradient(135deg, #fff7ed 0%, #fef3c7 50%, #ede9fe 100%)',
        'sidebar-gradient': 'linear-gradient(180deg, #1e1b4b 0%, #312e81 100%)',
        'login-bg': 'linear-gradient(135deg, #1e1b4b 0%, #312e81 40%, #4f46e5 100%)',
      },
      boxShadow: {
        'card': '0 1px 3px 0 rgb(0 0 0 / 0.04), 0 1px 2px -1px rgb(0 0 0 / 0.04)',
        'card-hover': '0 10px 25px -5px rgb(0 0 0 / 0.08), 0 8px 10px -6px rgb(0 0 0 / 0.04)',
        'float': '0 20px 60px -15px rgb(0 0 0 / 0.15)',
        'glow': '0 0 40px rgb(99 102 241 / 0.3)',
      },
      borderRadius: {
        '2xl': '1rem',
        '3xl': '1.5rem',
